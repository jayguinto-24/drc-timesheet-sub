              ...
              : (
                <div style={{ background: "#fff", border: "1px solid #e2e8f0", borderRadius: 12, overflow: "hidden" }}>
                  <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 13 }}>
                    <thead>
                      <tr style={{ background: "#f8fafc" }}>
                        {["Fortnight Starting", "Total Hours", "Submitted", "Status", ""].map(h => (
                    ...
                    <tbody>
                      {fortnightGroups.flatMap((group) => {
                        ...
                        // Derive group-level status (rejected > pending > approved)
                        ...
                        const rejectionBanner = (groupStatus === "rejected" && groupRejectionComments.length > 0) ? (
